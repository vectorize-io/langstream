...
public class ObjectMapperFactory {
    ...
    private static final ObjectMapper PRETTY_PRINT_MAPPER = MAPPER.copy()
            .configure(SerializationFeature.INDENT_OUTPUT, true);

    private static final ObjectMapper YAML_MAPPER = configureObjectMapper(new ObjectMapper(new YAMLFactory()));
