...
public class AppResourcesFactory {
    ...
    private static Job generateJob(
        ...
        return new JobBuilder()
                ...
                .withNewAffinity()
                .withNodeAffinity(podTemplate != null ? podTemplate.nodeAffinity() : null)
                .endAffinity()
    ...
    private static ApplicationLifecycleStatus getStatusFromJob(
        ...
        return switch (podStatus.getState()) {
            ...
            case ERROR -> delete
                    ? ApplicationLifecycleStatus.errorDeleting("Pod error:\n" + podStatus.getMessage())
                    : ApplicationLifecycleStatus.errorDeploying("Pod error:\n" + podStatus.getMessage());
        };
    }
